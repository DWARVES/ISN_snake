...
Le jeux compte 5 bonus par défaut :\begin{description}
	\item[base] ce bonus possède la plus grosse fréquence d'apparition. Il rapporte 5 points et augmente la longueur du serpent de 3 cases. Il disparaît au bout de 10 secondes.
	\item[big] ce bonus est assez rare, mais surtout il ne reste affiché que 1.5 secondes, ce qui le rend très difficile à attraper. Il rapporte 50 points et augmente la longueur du serpent de 5.
	\item[pic] ce \emph{bonus} est en fait un malus : il fait perdre 25 points et réduit la taille de 2 cases. Il a une fréquence d'apparition presque aussi élevée que le \emph{base} mais ne reste affiché que 1.5 secondes.
	\item[snake] ce bonus a une fréquence d'apparition plus faible. Il augmente beaucoup la longueur du serpent, c'est à dire de 10, mais ne rapporte que 2 points. Il disparaît au bout de 2 secondes.
